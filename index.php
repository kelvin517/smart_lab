...
<head>
  ...
  <title>SMART LABORATORY BOOKING SYSTEM</title>
      ...
      <div class="col-md-8">
        <div class="card shadow-lg rounded-4">
          <div class="card-body text-center">
            <h1 class="card-title mb-4">Welcome to the Smart Laboratory Booking System</h1>
            <p class="card-text mb-4">
              Book lab tests, track their status, and access results efficiently.<br>
